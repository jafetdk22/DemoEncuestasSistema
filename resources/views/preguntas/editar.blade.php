...
<div class="container">
    ...
    <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
                <form method="POST" action="/preguntas/{{$pregunta->id}}" class="formulario-eliminar">
                  @csrf
                  @method('PUT') 
                  <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                                <select name="emoji" id="emoji" class="form-select form-select-lg  mb-1 swal2-select swal2-input bg-light">
                                    <option value="{{$pregunta->emoji}}">--{{$pregunta->emoji}}--</option>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                                <select name="tipo" id="tipo" class="form-select form-select-lg  mb-1 swal2-select swal2-input bg-light">
                                    <option value="{{$pregunta->tipo}}">--{{$pregunta->tipo}}--</option>
                    ...
                    <div class="row mb-3">
                      <label for="concesion" class="col-md-2 col-form-label text-md-end"> Concesión <span class="m-2"></span></label><br>
                         <div class="col-md-6">
                            <select name="concesion" id="concesion" class="form-select form-select-lg mb-1 swal2-select swal2-input bg-light">
                                <option value="{{$pregunta->concesion}}">--{{$pregunta->concesion}}--</option>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-6">
                                <input id="pregunta" type="text" class="form-control @error('pregunta') is-invalid @enderror ml-4" name="pregunta" value="{{ $pregunta->pregunta }}" required autocomplete="pregunta" autofocus>
